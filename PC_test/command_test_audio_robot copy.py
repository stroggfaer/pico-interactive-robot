...
engine = pyttsx3.init()
engine.setProperty('voice', 'HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Speech\\Voices\\Tokens\\TTS_MS_RU_RU_IRINA_11.0')
engine.setProperty('rate', 150)  # медленнее
engine.setProperty('volume', 1.0)
engine.say("Привет, я робот с синтезированным голосом.")
engine.runAndWait()
...
# Первый запуск
speak_and_send("Привет, я робот с синтезированным голосом.")
