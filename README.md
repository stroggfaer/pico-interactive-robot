...
> **Важно:**  
> Я делал этот проект для удовольствия и экспериментов. Если вы решите использовать код или что-то изменить — всё на ваш страх и риск. Я не могу гарантировать, что всё будет работать идеально, но всегда рад, если мой опыт кому-то пригодится! :)
